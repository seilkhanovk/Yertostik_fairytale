...
open class FolioReaderConfig: NSObject {
    ...
    open var localizedHighlightsTitle   = NSLocalizedString("Белгілер", comment: "")

    /// Localizes Content title
    open var localizedContentsTitle     = NSLocalizedString("Мазмұны", comment: "")
    ...
    open var localizedHighlightMenu = NSLocalizedString("Белгілеу", comment: "")
    ...
    open var localizedFontMenuNight = NSLocalizedString("Түн", comment: "")
    open var localizedPlayerMenuStyle = NSLocalizedString("Style", comment: "")
    open var localizedFontMenuDay = NSLocalizedString("Күн", comment: "")
    open var localizedLayoutHorizontal = NSLocalizedString("Көлденең", comment: "")
    open var localizedLayoutVertical = NSLocalizedString("Тігінен", comment: "")
    open var localizedReaderOnePageLeft = NSLocalizedString("1 бет қалды", comment: "")
    open var localizedReaderManyPagesLeft = NSLocalizedString("бет қалды", comment: "")
    open var localizedReaderManyMinutes = NSLocalizedString("минут", comment: "")
    open var localizedReaderOneMinute = NSLocalizedString("1 минут", comment: "")
    open var localizedReaderLessThanOneMinute = NSLocalizedString("Бір минуттан кем", comment: "")
    ...
    open var localizedCancel = NSLocalizedString("Болдырмау", comment: "")
    ...
    open var localizedShareImageQuote = NSLocalizedString("Суретпен бөлісу", comment: "")
    open var localizedShareTextQuote = NSLocalizedString("Текстпен бөлісу", comment: "")
